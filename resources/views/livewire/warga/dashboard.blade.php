<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Main CTA -->
        <div
            class="lg:col-span-2 glass-card p-8 flex flex-col items-center justify-center text-center bg-linear-to-br from-slate-800 to-indigo-900/30 border-indigo-500/30">
            ...
            <p class="text-slate-300 mb-6 max-w-md">Ajukan berbagai jenis surat keterangan dengan mudah secara online.
                Proses cepat dan transparan.</p>
            <a href="{{ route('warga.pengajuan.create') }}"
                class="btn-primary flex items-center justify-center gap-2 text-lg px-6 py-3 w-max mx-auto">
        ...
        <div class="glass-card p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('warga.pengajuan.index') }}"
                    class="text-sm font-medium text-indigo-400 hover:text-indigo-300">Lihat Semua</a>
            </div>
